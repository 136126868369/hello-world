...
PAGE 0:    /* Program Memory */
   ...
   RAML0         : origin = 0x000050, length = 0x0007B0
   ...
   FLASHFED      : origin = 0x300000, length = 0x028000
...
PAGE 1 :   /* Data Memory */
  ...
  RAMM01       : origin = 0x008000, length = 0x001000     /* on-chip RAM block L0 */
  /*RAML3       : origin = 0x00B000, length = 0x001000 */    /* on-chip RAM block L3 */
   ...
   /*RAML4567      : origin = 0x00C000, length = 0x004000*/
    RAML234567      : origin = 0x00B000, length = 0x005000
...
SECTIONS
{
   ...
   .cinit              : > FLASHFED      PAGE = 0
   .pinit              : > FLASHFED,     PAGE = 0
   .text               : > FLASHFED      PAGE = 0
...
*/
   ...
   .stack              : > RAML1      PAGE = 1
   .ebss               : > RAMM01      PAGE = 1
   /*.esysmem            : > RAML3       PAGE = 1*//*动态内存*/
   .esysmem            : > RAML1       PAGE = 1/*动态内存*/

   /* Initalized sections go in Flash */
   /* For SDFlash to program these, they must be allocated to page 0 */
   .econst             : > FLASHFED      PAGE = 0
   .switch             : > FLASHFED      PAGE = 0
   ...
   //.MY_MEM1         : > RAML5,     PAGE = 1
   /*DMARAML6         : > RAML6,     PAGE = 1
   DMARAML7         : > RAML7,     PAGE = 1*/
  /* .MY_MEM0         : > RAML4567,    PAGE = 1 *//* 6k*16bit */
   .MY_MEM0         : > RAML234567,    PAGE = 1
