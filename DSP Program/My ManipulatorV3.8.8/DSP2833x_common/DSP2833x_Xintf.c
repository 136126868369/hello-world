...
void InitXintf(void)
{
    ...
    // Zone read timing
    XintfRegs.XTIMING0.bit.XRDLEAD = 3;//3
    XintfRegs.XTIMING0.bit.XRDACTIVE = 7;
    XintfRegs.XTIMING0.bit.XRDTRAIL = 3;//3

    // double all Zone read/write lead/active/trail timing
    XintfRegs.XTIMING0.bit.X2TIMING = 1;

    // Zone will sample XREADY signal
    XintfRegs.XTIMING0.bit.USEREADY = 1;//1
    XintfRegs.XTIMING0.bit.READYMODE = 1;  // sample asynchronous Òì²½²ÉÑù
    ...
    XintfRegs.XTIMING6.bit.XRDTRAIL = 2;//3

    // double all Zone read/write lead/active/trail timing
    XintfRegs.XTIMING6.bit.X2TIMING = 1;

    // Zone will sample XREADY signal
    XintfRegs.XTIMING6.bit.USEREADY = 1;//1
    ...
    XintfRegs.XBANK.bit.BANK = 7;//6
    XintfRegs.XBANK.bit.BCYC = 1;//6

    // Zone 7------------------------------------
    // When using ready, ACTIVE must be 1 or greater
    // Lead must always be 1 or greater
    // Zone write timing
    XintfRegs.XTIMING7.bit.XWRLEAD = 2;//3
    XintfRegs.XTIMING7.bit.XWRACTIVE = 7;
    XintfRegs.XTIMING7.bit.XWRTRAIL = 2;//3
    // Zone read timing
    XintfRegs.XTIMING7.bit.XRDLEAD = 2;//3
    XintfRegs.XTIMING7.bit.XRDACTIVE = 7;//
    XintfRegs.XTIMING7.bit.XRDTRAIL = 2;//3

    // double all Zone read/write lead/active/trail timing
    XintfRegs.XTIMING7.bit.X2TIMING = 1;

    // Zone will sample XREADY signal
    XintfRegs.XTIMING7.bit.USEREADY = 1;//1
